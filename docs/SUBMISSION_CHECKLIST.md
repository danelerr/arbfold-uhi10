...
| Progress Update 2 copy | Ready for manual submission | [`PROGRESS_UPDATE_2.md`](PROGRESS_UPDATE_2.md) is bound to the public v0.1 deployment, benchmark and canonical transaction. |
