...
check("Wallet bundle is explicitly versioned", page.includes('./app.js?v=receipt-state-2'));
...
if (publicMode) {
  try {
    ...
    check("Public dashboard serves current wallet bundle", publicPage.includes("./app.js?v=receipt-state-2"));
